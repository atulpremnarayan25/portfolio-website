      ...
      <div className="container mx-auto px-6 md:px-12 grid lg:grid-cols-3 gap-12 items-center relative z-10">
        ...
        <div className="lg:col-span-2 flex flex-col items-start">
          ...
          <motion.p
            ...
            className="hidden md:block text-lg md:text-xl text-white/50 max-w-xl font-light leading-relaxed mb-10"
          >
          ...
          <motion.p
            ...
            animate={{ opacity: 1 }}
            transition={{ duration: 0.7, delay: 0.5 }}
            className="md:hidden text-lg text-white/50 max-w-xl font-light leading-relaxed mb-10"
          >
          ...
          >
            <a 
              href="#work" 
              className="group flex items-center gap-2 bg-white text-black px-6 py-3 rounded-lg font-medium transition-all hover:bg-white/90"
            >
              View Projects
            ...
            <a 
              ...
              className="flex items-center gap-2 bg-white/5 border border-white/10 text-white px-6 py-3 rounded-lg font-medium transition-all hover:bg-white/10"
            >
              <GithubIcon size={18} />
              GitHub
            </a>

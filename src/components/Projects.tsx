...
const AbstractDiagram = ({ diagram }: { diagram: string[] }) => {
  return (
    <div className="w-full h-full min-h-[200px] md:min-h-[300px] flex flex-col items-center justify-center p-8 bg-[#0a0f18] rounded-xl border border-white/5 relative overflow-hidden group-hover:border-white/10 transition-colors">
            ...
            >
              <div className={cn(
                ...
                <div className="flex items-center gap-6">
                  <a href={project.demo} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm font-medium hover:text-blue-400 transition-colors">
                    View Project <ExternalLink size={16} className="group-hover:-translate-y-0.5 group-hover:translate-x-0.5 transition-transform" />
                  </a>
                  <a href={project.github} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm font-medium text-white/50 hover:text-white transition-colors">
              ...
              <div className={cn(
                ...
                {project.diagram ? (
                  <AbstractDiagram diagram={project.diagram} />
                ) : (
                  <div className="w-full aspect-[4/3] md:aspect-[16/9] flex items-center justify-center bg-[#0a0f18] rounded-xl border border-white/5 group-hover:border-white/10 transition-colors relative overflow-hidden">
                     ...
                     <span className="text-white/20 font-mono tracking-widest text-sm uppercase relative z-10">
